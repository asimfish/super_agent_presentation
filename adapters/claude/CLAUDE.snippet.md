...
objective/audience/surface/mode/must-show checkpoint; do not retain the bundle during
task work. At the reporting boundary, load only the routed bundle; after compaction,
resume, or handoff, reload the checkpoint first. Before a substantive final, audit
a file-backed draft when available and manually verify facts, claims, numbers,
links, and limits. If unavailable, disclose that and use the shortest
