...
| Generic AGENTS adapter body | 893 | 121 | Every applicable host request after installation |
| Skill activation description | 599 | 77 | Skill discovery metadata |
| Full `SKILL.md` | 6,321 | 845 | Only after Skill activation |
...
|---|---|---:|---:|
| `concise-answer` | — | 6,954 | 1,038 |
| `status-update` | — | 7,370 | 1,074 |
| `decision-brief` | conclusions | 10,727 | 1,510 |
| `incident-update` | evidence | 10,453 | 1,512 |
| `investigation-report` | evidence | 10,625 | 1,550 |
| `implementation-handoff` | evidence | 10,659 | 1,556 |
| `postmortem` | evidence | 10,836 | 1,557 |
| `review-report` | evidence | 11,016 | 1,598 |
| `risk-report` | tables, conclusions | 13,812 | 1,998 |
| `experiment-report` | tables, conclusions | 14,486 | 2,072 |
| `academic-synthesis` | evidence, academic-display | 14,898 | 2,143 |

All default bundles remain below the CLI's 16,000-character guard. An agent does not
need to read `protocols.json`, every mode, every module, every template, or the full
distribution. The strict JSON schema is loaded only for a strict report-spec task.
