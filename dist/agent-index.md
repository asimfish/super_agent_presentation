...
- [`benchmarking`](modules/benchmarking.md) — Report performance comparisons honestly: full-suite protocol, correct means, speedup and tail-latency discipline, complete platform disclosure, leakage and contamination checks, and human or model-judge reporting.
